...
function AddProductForm({ addNewProduct }) {
  ...
  const [productType, setProductType] = useState(""); // Added state for product type
  const [image, setImage] = useState(null); // Added state for image upload
  ...
  const handleSubmit = (e) => {
    ...
    const newProduct = {
      ...
      type: productType,
      sizes: selectedSizes, // from your checkboxes
