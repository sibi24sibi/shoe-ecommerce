      ...
      <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-6 px-4 my-12">
        {BannerData.map((item, index) => (
          ...
          >
            ...
            <h3 className="text-lg font-bold mb-2 dark:text-gray-100 text-gray-800">
              {item.title}
            </h3>
            ...
            <a
              href=""
              className="text-blue-600 dark:text-blue-200 font-bold inline-block text-sm mt-4 hover:underline"
            >
              Learn more
            </a>
          </div>
