      ...
      {showClearModal && (
        <div className="fixed inset-0 bg-gray-500 bg-opacity-50 flex justify-center items-center">
          <div className="bg-white p-6 rounded-lg shadow-lg max-w-sm w-full">
            ...
            <button
  onClick={() => setShowClearModal(true)}
  className="w-full mt-4 bg-red-500 text-white font-medium py-3 rounded-md transition-colors duration-300 hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-400"
>
  Clear All Cart
</button>
