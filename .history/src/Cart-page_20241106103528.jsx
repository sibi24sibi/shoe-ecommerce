...
function Cartpage() {
  ...
  className="w-full mt-4 bg-gradient-to-r from-red-500 to-red-600 text-white py-3 px-6 rounded-lg shadow-md transform transition-transform hover:scale-105 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-opacity-50"
>
  Clear All Cart
</button>
