        ...
        {slides.map((slide, index) => (
          ...
          >
            <section className="bg-white dark:bg-gray-900">
              <div className="grid flex justify-between max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                ...
                <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
                  <img src={slide.imgSrc} className=" size-72 " alt="mockup" />
                </div>
              </div>
            </section>
          </div>
