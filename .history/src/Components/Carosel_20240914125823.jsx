...
function Carousel() {
  ...
  return (
    <div className="relative w-full overflow-hidden">
      ...
      {/* Slides */}
      <div className="relative min-h-[55svh] md:min-h-[65svh] w-full">
        {slides.map((slide, index) => (
          ...
          >
            <section className="bg-white dark:bg-gray-900 img-bg md:bg-none flip-img">
              <div className=" grid md:flex md:justify-between max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 flip-img">
