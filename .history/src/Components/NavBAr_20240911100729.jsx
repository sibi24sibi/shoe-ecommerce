          ...
          <div className="flex items-center space-x-6 rtl:space-x-reverse">
            ...
            >
              <div className="relative">
                ...
                <span className="md:top-0 md:left-7 md:absolute absolute top-0 left-2 w-1 h-1   md:w-3.5 md:h-3.5 bg-green-400 border-2 border-white dark:border-gray-800 rounded-full"></span>
              </div>
            </NavLink>
          </div>
        </div>
