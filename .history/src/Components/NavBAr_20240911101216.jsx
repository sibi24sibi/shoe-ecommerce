          ...
          <div className="flex items-center space-x-6 rtl:space-x-reverse">
            ...
            >
              <div className="relative">
                <div className="relative md:w-9 md:h-9 w-6  h-6 text-center overflow-hidden bg-gray-100 rounded-full dark:bg-gray-600">
                  <FontAwesomeIcon
                    icon={faUserTie}
                    className=" md:w-7 md:h-7  md:translate-y-2"
                  />
                </div>
                <span className="top-0 left-4 absolute  w-3.5 h-3.5 bg-green-400 border-2 border-white dark:border-gray-800  block md:hidden rounded-full"></span>
