      ...
      <nav className="bg-white border-gray-200 dark:bg-gray-900">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-2xl p-4">
          ...
          <div className="flex items-center space-x-6 rtl:space-x-reverse">
            ...
            >
              <span
                className={`absolute inline-block md:w-4 md:h-4 w-2 h-2  bg-blue-200 dark:bg-blue-500 p-3 bg-white dark:bg-gray-300 rounded-full transition-transform transform ${
                  darkTheme
