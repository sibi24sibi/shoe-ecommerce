      ...
      <nav className="bg-white border-gray-200 dark:bg-gray-900">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-2xl p-4">
          ...
          <div className="flex items-center space-x-6 rtl:space-x-reverse">
            ...
            <button
              onClick={toggleTheme}
              className="relative inline-flex items-center  text-sm md:text-lg p-1 bg-blue-200 dark:bg-blue-400 rounded-full md:w-12 md:h-6 w-6   h-3 transition-colors duration-300 focus:outline-none shadow-md"
            >
              <span
