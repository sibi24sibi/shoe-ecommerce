            ...
            >
              <div className="relative">
                <div className="relative md:w-9 md:h-9 w-10  h-10 text-center overflow-hidden bg-gray-100 rounded-full dark:bg-gray-600">
                  <img
                    src={assets.userlogo}
                    className=" md:size-8   rounded-full"
                    alt=""
                  />
                </div>
                <span className="top-1 left-7 absolute   w-3 h-3 bg-green-400 border-2 border-white dark:border-gray-800  block md:hidden rounded-full"></span>
