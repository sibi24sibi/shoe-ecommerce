          ...
          <div className="flex items-center space-x-6 rtl:space-x-reverse">
            ...
            >
              <div className="relative">
                <img
                  src={assets.userlogo}
                  className=" size-8 border-y-cyan-50  border-4  translate-x- translate-y-1   rounded-full"
                  alt=""
                />

                <span className="top-0 left-6 absolute   w-3 h-3 bg-green-400 border-2 border-white dark:border-gray-800  block md:hidden rounded-full"></span>
