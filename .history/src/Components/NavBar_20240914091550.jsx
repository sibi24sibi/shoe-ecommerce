          ...
          <div className="flex items-center space-x-6 rtl:space-x-reverse">
            ...
            >
              <div className="relative">
                ...
                <span className="top-0 left-7 absolute   w-3 h-3 bg-green-400 border-[3rem] border-white dark:border-gray-800  block md:hidden rounded-full"></span>
                <span className="top-1 left-6 absolute  w-3 h-3 bg-green-400 border-2 border-white dark:border-gray-800  hidden md:block rounded-full"></span>
              </div>
            </NavLink>
          </div>
        </div>
