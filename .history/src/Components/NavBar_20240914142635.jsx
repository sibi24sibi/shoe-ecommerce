          ...
          <ul className="flex justify-center space-x-6 text-sm font-medium">
            <li>
              <NavLink
                ...
                className={({ isActive }) =>
                  isActive
                    ? "text-gray-900 dark:text-white shadow-lg shadow-indigo-500/50 rounded-lg px-4 py-2"
                    : "text-gray-900 dark:text-white hover:underline text-base font-semibold"
                }
                aria-current="page"
              >
                Home
