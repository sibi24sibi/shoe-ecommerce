...
// Function to generate an array of star icons based on the rating
...
function Products({ name, image, price, rating }) {
  return (
    <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow-lg transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl dark:bg-gray-800 dark:border-gray-700">
      <a href="#">
        <img
      ...
      <div className="px-5 pb-5">
        ...
        <div className="flex items-center mt-2.5 mb-5">
          <div className="flex items-center">
            {generateStars(rating)} {/* Display dynamic stars */}
          </div>
        </div>
