...
function Products({ name, image, price }) {
  return (
    <div className="w-full max-w-sm    transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl hover:dark:bg-gray-800 dark:border-gray-700">
      <a href="#">
        <img
