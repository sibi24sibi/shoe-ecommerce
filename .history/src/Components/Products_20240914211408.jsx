...
function Products({ name, image, price }) {
  return (
    <div className="w-full max-w-sm lg:btn-shine    transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl hover:dark:bg-gray-800 hover:dark:border-gray-700">
      <a href="#">
        <img
