...
function Products({ name, image, price, id }) {
  return (
    <div className="w-full max-h-12 max-w-sm btn-shine transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl hover:dark:bg-gray-800 hover:dark:border-gray-700">
