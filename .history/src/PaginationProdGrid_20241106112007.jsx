    ...
    <>
      ...
      <div className="grid md:grid-cols-3 grid-cols-1 gap-4 m-8">
        {isLoading ? (
          ...
          <div className=" h-60 w-screen flex justify-center items-center items-center col-span-2">
...
<div role="status">
    ...
    <span className="sr-only">Loading...</span>
          ...
          <p className="flex justify-center items-center h-60">No products available</p>
        )}
      </div>
