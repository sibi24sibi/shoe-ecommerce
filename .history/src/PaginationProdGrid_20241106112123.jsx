...
function PaginationProdGrid() {
  const { products, isLoading } = useContext(ShopContext); // Assuming `isLoading` is part of the context
  ...
  return (
    <>
      ...
      <div className="grid md:grid-cols-3 grid-cols-1 gap-4 m-8">
        {isLoading ? (
          // Display loading text or spinner while products are being fetched
          <div className=" h-60 w-full flex justify-center text-center items-center col-span-2">
...
<div role="status">
    ...
    <span className="sr-only">Loading...</span>
          ...
          <p className="flex justify-center text-center items-center h-60">No products available</p>
        )}
      </div>
