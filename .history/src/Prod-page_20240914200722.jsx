  ...
  return (
    <>
      <div>
        ...
        <div>
          <h2 className="text-4xl font-semibold  my-5 text-center uppercase">
            Featured Products
          </h2>
          <h2 className="text-7xl  whitespace-nowrap opacity-10 font-semibold text-center  uppercase relative -translate-y-14">
            Featured Products
          </h2>
        </div>
        <PaginationProdGrid />
