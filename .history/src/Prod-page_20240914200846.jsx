  ...
  return (
    <>
      <div>
        ...
        <div className="my-5">
          <h2 className="text-5xl  font-extrabold   text-center uppercase">
            Featured Products
          </h2>
          <h2 className="text-8xl  whitespace-nowrap opacity-10 font-semibold text-center  uppercase relative -translate-y-12">
            Featured Products
          </h2>
        </div>
        <PaginationProdGrid />
