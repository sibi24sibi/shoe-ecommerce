  ...
  return productShoesData ? (
    <div className="flex">
      ...
      <div className="  space-y-3">
        ...
        <li>
          <ul>Free Delivery, Free Returns</ul>
          <ul>Delivery: Delhi, Gurgaon: 1-2 Days, Metro cities:2-3 days , Others: 3-5 days</ul>

COD available for orders below ₹5000
Secure transactions with hassle free 14 days Exchange and Returns
Save 5% on all Online Payments under Rs 5000/-</ul>
        </li>
      </div>
    </div>
  ) : (
