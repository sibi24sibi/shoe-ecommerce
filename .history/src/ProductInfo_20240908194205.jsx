  ...
  return productShoesData ? (
    <div className="flex">
      ...
      <div className="  space-y-3">
        ...
        <ul>
          <li>
            <FontAwesomeIcon icon={faShoePrints} /> Free Delivery, Free Returns
          </li>
          <li>
          ...
          <li>
            <FontAwesomeIcon icon={faShoePrints} /> COD available for orders
            below ₹5000
          </li>
          <li>
            <FontAwesomeIcon icon={faShoePrints} />
          ...
          <li>
            <FontAwesomeIcon icon={faShoePrints} /> Save 5% on all Online
            Payments under Rs 5000/-
          </li>
        </ul>
      </div>
    </div>
