          ...
          <div>
            ...
            <ul className="text-xs space-y-3 py-6">
              ...
              <li>
                ...
                Delivery: Delhi, Gurgaon: 1-2 Days, Metro cities: 2-3 days,
                Others: 3-5 days
              </li>
              <li>
              ...
              <li>
                <FontAwesomeIcon className="mx-3" icon={faShoePrints} />
                Secure transactions with hassle-free 14 days Exchange and
                Returns
              </li>
              <li>
                <FontAwesomeIcon className="mx-3" icon={faShoePrints} /> Save 5%
                on all Online Payments under Rs 5000/-
              </li>
            </ul>
          </div>
