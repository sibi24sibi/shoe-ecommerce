    ...
    <div className="flex md:flex-row flex-col bg-white dark:bg-slate-950 transition duration-300">
      ...
      <div className=" md:w-1/2 space-y-3 mx-8 md:mx-0 m-5 text-gray-900 dark:text-gray-100">
        ...
        <button
          ...
          className="px-4  flex  items-centerpy-2 bg-yellow-900 text-white font-bold rounded-md hover:bg-yellow-800 dark:bg-yellow-600 dark:hover:bg-yellow-500 transition duration-300"
        >
          <BiCart />
