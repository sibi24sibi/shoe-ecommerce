  ...
  return (
    <>
      ...
      <div className="flex justify-center my-8">
        <div className="grid grid-col-1 md:grid-cols-3 gap-4 w-full max-w-4xl px-12 md:px-0">
          {cardData.map((card, index) => (
            <a
              key={index}
              href="#"
              className="flex flex-col justify-center items-center aspect-square h-72 p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700"
            >
